...
| TS.STAT.001 | TC.STAT.001.006 | Switch Filter Grafik ke Bulanan | Positive | Mengubah filter grafik kunjungan dari mingguan ke bulanan | User berada di halaman Dashboard Admin | 1. Klik tombol "Bulanan" pada bagian Statistik Kunjungan 2. Perhatikan perubahan subjudul grafik 3. Klik tombol "Mingguan" untuk mengembalikan filter | Subjudul grafik berubah menjadi "Tren volume pasien bulanan" saat tombol Bulanan diklik, dan kembali menjadi "Tren volume pasien mingguan" saat tombol Mingguan diklik |
